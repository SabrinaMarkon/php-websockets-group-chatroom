    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <form method="post" accept-charset="utf-8" class="form" role="form">
                ...
                <input type="text" name="adminuser" value="<?php echo $adminuser ?>" class="form-control input-lg" 
                placeholder="Admin Username" required minlength="6s" maxlength="255" autocomplete="username">

                <label class="sr-only" for="adminpass">Admin Password</label>
                <input type="password" name="adminpass" value="<?php echo $adminpass ?>" class="form-control input-lg" 
                placeholder="Admin Password" required minlength="6" maxlength="255" autocomplete="current-password">

                <label class="sr-only" for="confirm_adminpass">Confirm Password</label>
                <input type="password" name="confirm_adminpass" value="<?php echo $adminpass ?>" class="form-control input-lg" 
                placeholder="Confirm Password" required minlength="6" maxlength="255" autocomplete="current-password">

                <label class="sr-only" for="adminemail">Your Admin Email</label>
                <input type="email" name="adminemail" value="<?php echo $adminemail ?>" class="form-control input-lg" 
                placeholder="Admin Email" required minlength="4" maxlength="255" autocomplete="email">
